...
const DEFAULT_STYLE = STYLE.SAT;
const DEFAULT_ACTIVATION_RADIUS = 10; //meters
const DEFAULT_CENTER = [-84.7527, 10.4925];
const DEFAULT_ZOOM   = 15;
const MAX_BOUNDS = [[-84.7634, 10.4848], [-84.7419, 10.5001]];

const TRIGGER_GPS_ON_START = false;
const FLY_TO_ON_START      = false;

const POI_FILE      = "./data/" + SITE +"/poi.geojson";
const ROUTE_FILE    = "./data/" + SITE +"/route.geojson";
const PARKING_FILE  = "./data/" + SITE +"/parking.geojson";
...
// $(document).ready(function () {
    ...
    class BaseMapControl {
        onAdd(map) {
            ...
            this._container.className = 'maplibregl-ctrl maplibregl-ctrl-group style-switcher style-switcher-streets';
